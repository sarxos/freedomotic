...
public class Enocean
    ...
    private static final Logger LOG = Logger.getLogger(Enocean.class.getName());
    private String CONNECTOR_PORT = configuration.getStringProperty("connector-port", "");

    public Enocean() {
        super("Enocean", "/enocean/enocean-manifest.xml");
    ...
    protected void onStart() {
        LOG.info("Enocean plugin started");
        EnoceanClient client = new EnoceanClient();
        client.connect(CONNECTOR_PORT);

    }

    @Override
    protected void onStop() {
        LOG.info("Enocean plugin stopped ");
    }
